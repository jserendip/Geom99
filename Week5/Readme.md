...
###             My layer in a web map with data added URL: https://fleming.maps.arcgis.com/home/webmap/viewer.html?webmap=28448dffff69455783f11c3d61697492
    ...
    ?token= 	
    [optional] The access token for your login or the Developers API key. This is only required for secured services (those not shared publicly). If it is a public service no token is necessary. 
